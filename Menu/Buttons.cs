    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Change PC GUI Background", method =() => Settings.ChangePCGUI(), enableMethod =() => Settings.ChangePCGUI(), disableMethod =() => Settings.ChangePCGUI(false), incremental = true, isTogglable = false, toolTip = "Changes the background of the PC GUI."},
            ...
            new[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "Uncap Arm Length", aliases = new[] { "Armmax" }, method =() => { if (GTPlayer.Instance != null) GTPlayer.Instance.maxArmLength = float.MaxValue; }, disableMethod =() => { if (GTPlayer.Instance != null) GTPlayer.Instance.maxArmLength = 1f; }, toolTip = "Removes the arm distance limit."},
            ...
            new[] { // Visual Mods [11]
                ...
                new ButtonInfo { buttonText = "Latency Debug Overlay+", method = Visuals.LatencyDebugOverlayPlus, disableMethod = Visuals.DisableLatencyDebugOverlayPlus, toolTip = "Displays ping diagnostics such as average ping, jitter, spike rate, range, and a live graph."},
                ...
                new ButtonInfo { buttonText = "Playtime Overlay", method =() => { Visuals.UpdatePlaytime(); NotificationManager.information["Playtime"] = Visuals.OverallPlaytime; }, disableMethod =() => NotificationManager.information.Remove("Playtime"), toolTip = "Displays your play time from when the mod was enabled on your screen."},
