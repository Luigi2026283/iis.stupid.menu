    ...
    public class Visuals
    {
        ...
        */
        ...
        public static void JumpPredictions()
        {
            ...
            foreach (var lines in predictions.Where(lines => !GorillaParent.instance.GetRigs().Contains(lines.Key)))
            {
        ...
        public static void HitboxPredictions()
        {
            ...
            foreach (var box in hitboxESP.Where(box => !GorillaParent.instance.GetRigs().Contains(box.Key)))
            {
        ...
        public static void NameTags()
        {
            ...
            foreach (var nametag in nametagsCopy.Where(nametag => !GorillaParent.instance.GetRigs().Contains(nametag.Key)))
            {
                Object.Destroy(nametag.Value);
                nametags.Remove(nametag.Key);
            }

            foreach (var vrrig in GorillaParent.instance.GetRigs().Where(vrrig => !vrrig.isLocal || selfNameTag))
            {
        ...
        public static void KIDNameTags()
        {
            ...
            {
                if (!GorillaParent.instance.GetRigs().Contains(nametag.Key))
                {
                    Object.Destroy(nametag.Value);
        ...
        public static void MinecraftTags()
        {
            ...
            foreach (var tag in tagCopy.Where(tag => !GorillaParent.instance.GetRigs().Contains(tag.Key)))
            {
        ...
        {
            foreach (var vrrig in GorillaParent.instance.GetRigs().Where(vrrig => vrrig.mainSkin.material.name.Contains("gorilla_body") && vrrig.mainSkin.material.shader == Shader.Find("GorillaTag/UberShader")))
        ...
        public static void CosmeticESP()
        {
            ...
            foreach (var nametag in indicatorCopy.Where(nametag => !GorillaParent.instance.GetRigs().Contains(nametag.Key)))
            {
                Object.Destroy(nametag.Value);
        ...
        public static void CasualBoneESP()
        {
            ...
            foreach (var boness in boneESP.Where(boness => !GorillaParent.instance.GetRigs().Contains(boness.Key)))
            {
        ...
        public static void InfectionSkeletonESP()
        {
            ...
            if (isInfectedPlayers)
            {
                ...
                {
                    foreach (var vrrig in GorillaParent.instance.GetRigs().Where(vrrig => !vrrig.IsTagged() && !vrrig.isLocal))
                    {
                        vrrig.skeleton.renderer.enabled = true;
                        vrrig.skeleton.renderer.material.shader = Shader.Find("GUI/Text Shader");
                        vrrig.skeleton.renderer.material.color = vrrig.playerColor;
        ...
        public static void CasualWireframeESP()
        {
            ...
            foreach (var lines in wireframes.Where(lines => !GorillaParent.instance.GetRigs().Contains(lines.Key)))
            {
                toRemove.Add(lines.Key);
        ...
        {
            foreach (var vrrig in GorillaParent.instance.GetRigs().Where(vrrig => !vrrig.isLocal && vrrig.colorInitialized && vrrig.initializedCosmetics && vrrig.mainSkin.material.shader.name != "Custom/UberChams"))
            {
                if (!uberChams)
        ...
        public static void CasualBoxESP()
        {
            ...
            foreach (var box in boxESP.Where(box => !GorillaParent.instance.GetRigs().Contains(box.Key)))
            {
                toRemove.Add(box.Key);
                Object.Destroy(box.Value);
            }
        ...
        public static void CasualHollowBoxESP()
        {
            ...
            foreach (var box in hollowBoxESP.Where(box => !GorillaParent.instance.GetRigs().Contains(box.Key)))
            {
                toRemove.Add(box.Key);
                Object.Destroy(box.Value);
            }
        ...
        public static void CasualBreadcrumbs()
        {
            ...
            foreach (var lines in breadcrumbs.Where(lines => !GorillaParent.instance.GetRigs().Contains(lines.Key)))
            {
                toRemove.Add(lines.Key);
                Object.Destroy(lines.Value);
            }
        ...
        public static void CasualTracers()
        {
            ...
            foreach (VRRig playerRig in GorillaParent.instance.GetRigs())
            {
        ...
        public static void NearestTracer()
        {
            ...
            foreach (var rig in GorillaParent.instance.GetRigs().Where(rig => distance > Vector3.Distance(rig.transform.position, VRRig.LocalRig.transform.position) && !rig.isLocal))
            {
        ...
        public static void HuntTracers()
        {
            ...
            foreach (var playerRig in GorillaParent.instance.GetRigs().Where(playerRig => !playerRig.isLocal))
            {
